...
namespace AdvertApi.Services
{
    public class DynamoDBAdvertStorage : IAdvertStorageService
    {
        ...
        Task<bool> IAdvertStorageService.CheckHealthAsync()
        {
        ...
        Task<List<AdvertModel>> IAdvertStorageService.GetAllAsync()
        {
            throw new NotImplementedException();
        }

        Task<AdvertModel> IAdvertStorageService.GetByIdAsync(string id)
        {
            throw new NotImplementedException();
        }
    }
